...
<div <?php if($_SESSION["varadmin"]==1){echo "style='transform: translate(-300px,0px);'";}?> class="sidebar2" id="sideLeft2">	
    ...
    <div id="button" onclick="var newname=window.prompt('Please enter new village name');if(newname===null){}else{window.location.href = '../tetrium.php?newvillagename=' + newname;}">Change village name</div>
...
<div style="width: 200px; float: right;">
    ...
    <?php if ($attack_timer_event_ammount_in>0){
...
<?php }
/**
 *TROOP TRAINING TIMER JAVASCRIPT
 **/
