...
}else{setTimeout("sidebar_timedown<?php echo $sendres_timer_event_min_time_id_out; ?>(stro_completed)",1000)}
}	
</script>
...
setTimeout("location.reload();",2000);
document.getElementById(element_id).innerHTML = "Done";
}else{setTimeout("sidebar_timedown<?php echo $sendres_timer_event_min_time_id_in; ?>(stro_completed)",1000)}
}	
</script>
...
setTimeout("location.reload();",2000);
document.getElementById(element_id).innerHTML = "Done";
}else{setTimeout("sidebar_timedown<?php echo $returning_sendres_timer_event_min_time_id; ?>(stro_completed)",1000)}
}	
</script>
...
setTimeout("location.reload();",2000);
document.getElementById(element_id).innerHTML = "Done";
}else{setTimeout("sidebar_timedown<?php echo $attack_timer_event_min_time_id_out; ?>(stro_completed)",1000)}
}	
</script>
...
setTimeout("location.reload();",2000);
document.getElementById(element_id).innerHTML = "Done";
}else{setTimeout("sidebar_timedown<?php echo $attack_timer_event_min_time_id_in; ?>(stro_completed)",1000)}
}	
</script>
...
setTimeout("location.reload();",2000);
document.getElementById(element_id).innerHTML = "Done";
}else{setTimeout("sidebar_timedown<?php echo $returning_attack_timer_event_min_time_id; ?>(stro_completed)",1000)}
}	
</script>
...
setTimeout("location.reload();",2000);
document.getElementById(element_id).innerHTML = "Done";
}else{setTimeout("sidebar_timedown<?php echo $troop_timer_event_min_time_id; ?>(stro_completed)",1000)}
}	
</script>
