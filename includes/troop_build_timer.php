...
<script>	
function troop_secondsdate_timer_editon(seconds){
...
echo $troop_timer_unit[$timer_event_id]," (Amount ", $troop_timer_amount[$timer_event_id],") ","&nbsp;&nbsp;&nbsp;&nbsp;<b id=timer_id_".$timer_event_id." name=timer_id_".$timer_event_id.">Javascript Error</b>&nbsp;&nbsp;&nbsp;&nbsp;"," Done at: ",$troop_timer_completed[$timer_event_id] ," <a href=/tetrium/executables/func_start.php?type=speedup&event_id=",$timer_event_id,">Speed up</a>","<br>";
}else{
...
<script>
	...
	stro_completed="<?php echo $troop_timer_stro_completed[$timer_event_id]; ?>";
...
var value_output = troop_secondsdate_timer_editon(timediff_epoch_stro_completed);	
